...
func main() {
	...
	for x < 10 { // while yapısına benzer
		fmt.Println(x)
		x++
	}
...
// Diğer koşullarında test edilmesini istediğimizde fallthrough kullanırız.
...
// idiomatic => mümkün olduğunca if-else yapısından kurtulmak gerekiyor.
// Gereksiz koşul yazımından kurtulmak gerekiyor.
